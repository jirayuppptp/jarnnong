  ...
  return (
    <div className="bg-[#050d0d] text-slate-200 min-h-screen font-sans">
      ...
      <section className="relative overflow-hidden pt-28 pb-40">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0df2f2]/10 border border-[#0df2f2]/30 text-[#0df2f2] text-sm font-bold mb-10 tracking-widest uppercase">
            ...
            {/* Heading */}
            <h1
              className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tight text-white mb-8 leading-[1.05] font-display"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                className="w-full sm:w-auto px-10 py-5 bg-[#0df2f2] text-[#050d0d] font-extrabold text-lg rounded-2xl flex items-center justify-center gap-3 hover:-translate-y-1 transition-all"
                style={{ boxShadow: '0 0 25px rgba(13,242,242,0.3)' }}
                onMouseEnter={e => e.currentTarget.style.boxShadow = '0 0 40px rgba(13,242,242,0.6)'}
                onMouseLeave={e => e.currentTarget.style.boxShadow = '0 0 25px rgba(13,242,242,0.3)'}
              >
                ดูบทเรียนล่าสุด
        ...
        {/* Brand Logos */}
        <div className="mt-24 max-w-6xl mx-auto px-4 opacity-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                icon: 'task_alt',
                title: 'Productivity',
                desc: 'ทำงานเร็วขึ้น 10 เท่าด้วยระบบวิจัย เอกสาร และแชทบอทอัจฉริยะที่ช่วยจัดการงานยาก',
                items: ['AI Chatbots', 'Document Summarization', 'Research Assistants'],
              },
            ].map(card => (
              <div
                key={card.title}
                className="group relative p-10 rounded-3xl bg-[#0a1a1a] border border-[#0df2f2]/10 hover:border-[#0df2f2]/50 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-900 rounded-[2.5rem] p-3 border border-slate-800 shadow-2xl overflow-hidden aspect-video flex items-center justify-center group cursor-pointer">
                ...
                <div className="flex flex-col items-center gap-6 relative z-10">
                  ...
                  <span className="text-slate-300 font-bold text-lg">ดูวิดีโอแนะนำ Hub ของเรา</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className="bg-[#0df2f2] rounded-[3rem] p-12 md:p-24 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden"
            style={{ boxShadow: '0 20px 60px -15px rgba(13, 242, 242, 0.3)' }}
          >
            <div className="absolute top-0 right-0 w-96 h-96 bg-white/20 rounded-full -mr-40 -mt-40 blur-[100px]" />
            ...
            <div className="relative z-10 w-full md:w-auto">
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="px-8 py-5 rounded-2xl border-none focus:ring-4 focus:ring-[#050d0d]/20 w-full sm:w-80 text-lg text-[#050d0d] outline-none"
                />
                <button className="px-10 py-5 bg-[#050d0d] text-white font-extrabold text-lg rounded-2xl hover:bg-black hover:shadow-2xl transition-all shrink-0">
                  ติดตามเลย
                </button>
              </div>
            </div>

export default function Hero() {
    ...
    return (
        <section className="relative overflow-hidden pt-20 pb-32 mesh-gradient">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <button className="btn-primary w-full sm:w-auto px-8 py-4 flex items-center justify-center gap-2 text-base">
                            ดูบทเรียนล่าสุด
            ...
            {/* Brand logos */}
            <div className="mt-20 max-w-5xl mx-auto px-4 opacity-40">
                <div className="flex flex-wrap justify-center gap-8 md:gap-16">
                    {brands.map((brand) => (
                        <div key={brand} className="text-xl font-bold text-text-secondary tracking-wide">
                            {brand}
                        </div>
                    ))}
                </div>
